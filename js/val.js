...
function validar(opm){
	...
	x.value = trim(x.value);
	  ...
	  if (x.value.length==0 && y.value < 0){
		alert("Ingrese el N° de DNI / Pasaporte / Carne de Extranjeria.");
		y.focus();
		return false;
	}
	...
	*/
	...
	document.getElementById("botonPasarF2").style.visibility = "hidden";
}else{	
	/*****************************************************************************************************************
	 *****************************************************************************************************************
	 ** HOJA 2
