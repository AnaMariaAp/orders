...
function validar(opm){
	...
	{
	    alert("Debe seleccionar el Tipo de Administración del Usuario Administrador.");
	    return false;
	}
	else
	{
	    if(y.checked == true)
	    {
		    ...
		    if(w==0)
		    {
		        alert("Debe seleccionar el Tipo de Administración Conjunta.");
		        return false;
		    }
	    }
	}
	...
	/********************************/
	/* Firma de Ordenes del User Adm*/
	/********************************/
	x = document.f.radioTipoFirma;
	var w = 0;
    ...
    if(w==0)
    {
        alert("Debe seleccionar el Tipo de Firma de Órdenes del Usuario Administrador.");
        return false;
    }
