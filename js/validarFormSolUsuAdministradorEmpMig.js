...
/*nuevo 09/08/2013 kgca*/
function habilitarModf(){
	var x=document.f.tipoInscripcion;
	if(document.f.codUsuario.value.length==8){
...
function validar(opm){
	...
	if(x.checked == false && y.checked == false)
	{
		...
		document.f.checkExisteUserSi.focus();
	    return false;
	}
	else
	{
	    if(x.checked == true)
	    {
	        if(z.value.length == 0)
	        {
				...
				document.f.txtCodUserBcaElec.focus();
                return false;
	        }
	        else
	        {
	            if(a.checked == false && b.checked == false)
	            {
					...
					document.f.checkPoseeTokenSi.focus();
	                return false;
	            }
	            else
	            {
	                if(a.checked == true)
	                {
	                    if(c.value.length == 0)
	                    {
							...
							document.f.txtNroDispToken.focus();
                            return false;
	                    }
	                }
	            }
...
/*nuevo 09/08/2013 kgca*/
function habilitarSeccionResto(check){
...
function habilitarSeccionDatos(check){
var value = check.checked;
...
function habilitarSeccionPerfil(check){
var value = check.checked;
