...
function validar(opm){
	...
	if (y.value.length==0){
	    ...
	    {
	        if (y.value.length < 8 || !soloDigitos(y.value))
	        {
	...
	z=document.f.checkSolicitud2;
	
	
	if (((document.f.checkSolicitud2.checked||!document.f.checkSolicitud.checked)&&
	      (!document.f.checkSolicitud2.checked||document.f.checkSolicitud.checked))){
...
function desactivarReposicionGar(){
   
   document.f.checkSolicitud.checked=false;
}
function desactivarReposicionPerd(){
   document.f.checkSolicitud2.checked=false;
}
